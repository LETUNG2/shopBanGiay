	...
	<div class = "hoadon">
		...
		<table border="1" align="center">
			...
			<tr>
				...
				<td colspan="2"><?php $tien=0; foreach($t as $a){ $tien += $a;} echo $tien + $vc; ?></td>
			</tr>
		</table>
	</div>
	<div class="duyet" align="center">
		<a href="../trangchuad.php?cn=qldh">Trở lại</a>
		<a href="duyetdon.php?id=<?php echo $id; ?>">Duyệt đơn hàng</a>
